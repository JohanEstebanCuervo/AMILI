...
def size_squares(contours: list) -> tuple:
    """
...
def filter_squeare_cont(contours: list) -> tuple:
    """
...
def groups_squeares(centers: list, max_dist: int = 10) -> list:
    """
...
def angle_size_estimation(contours_squares: list, edges: list) -> tuple:
    """
...
def angle_regression(centers: list, orientation: int, size: tuple = None) -> float:
    """
...
def interpolate_centers(centers: list, angle: float, size: tuple = None) -> tuple:
    """
    ...
    except IndexError as error_exc:
        print(f"ERROR!: {error_exc}")
