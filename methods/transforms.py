...
def function_f(arg_x: np.ndarray) -> np.ndarray:
    """
...
def invert_f(arg_x: np.ndarray) -> np.ndarray:
    """
...
def function_g(arg_x: np.ndarray) -> np.ndarray:
    """
...
def invert_g(arg_x: np.ndarray) -> np.ndarray:
    """
